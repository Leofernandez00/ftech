import sqlite3
from tkinter import messagebox, Tk, Label, Entry, Button, Listbox, END, SINGLE
...
class TelaCadastro:
    def __init__(self, master):
        ...
        self.lista_usuarios = Listbox(master, selectmode=SINGLE)
        self.lista_usuarios.grid(row=3, columnspan=3, padx=10, pady=10)
        self.lista_usuarios.bind("<<ListboxSelect>>", self.selecionar_usuario)  # Adiciona evento de seleção na lista
    ...
    def atualizar(self):
        ...
        try:
            ...
            id = self.lista_usuarios.get(self.lista_usuarios.curselection())[0]
    ...
    def carregar_usuarios(self):
        ...
        for user in usuarios:
            self.lista_usuarios.insert('end', (user[0], user[1]))  # Insere o ID e o nome do usuário na lista

    def selecionar_usuario(self, event):
        # Atualiza os campos de entrada com os detalhes do usuário selecionado
        indice = self.lista_usuarios.curselection()[0]
        usuario = self.lista_usuarios.get(indice)
        self.entry_usuario.delete(0, 'end')
        self.entry_usuario.insert('end', usuario[1])  # Insere o nome do usuário no campo de entrada
        self.entry_senha.delete(0, 'end')
        self.entry_senha.insert('end', '')  # Limpa o campo de senha
