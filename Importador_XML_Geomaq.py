...
root = tk.Tk()
root.title("Importador de XML - Alta Paulista")
...
def processar_xmls():
            ...
            for caminho in arquivos:
                ...
                try:
                    ...
                    for det in infNFe.findall('nfe:det', NS):
                        ...
                        ncm = prod.findtext('nfe:NCM', default='', namespaces=NS).strip()
                        ...
                        try:
                            cursor.execute('''
                                INSERT INTO FTECH_XML (
                                    ...
                                    prod_codigo, prod_nome, prod_ncm, prod_cfop, prod_quantidade,
                            ...
                            ''', (
                                ...
                                emit_mun, emit_uf, dest_cnpj, dest_nome, cProd, xProd, ncm,
    ...
    root.after(900000, iniciar_importacao)
